...
const source = (await readFile(new URL('../src/client.js', import.meta.url), 'utf8'))
  ...
  .replace('const BUILTIN_CHARACTERS = [];', `const BUILTIN_CHARACTERS = ${JSON.stringify([{ id: 'shinchan', name: '小新', size: 150, assets }, { id: 'orange-cat', name: '橘猫', size: 150, assets: catAssets }])};`)
